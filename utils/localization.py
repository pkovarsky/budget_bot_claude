...
MESSAGES = {
    "ru": {
        ...
        # Уведомления
        "daily_reminder": "📅 **Напоминание**\n\nНе забудьте добавить траты за сегодня!\n\nИспользуйте формат: '35 EUR продукты' или просто отправьте фото чека.",
    },
    ...
    "uk": {
        ...
        # Уведомления
        "daily_reminder": "📅 **Нагадування**\n\nНе забудьте додати витрати за сьогодні!\n\nВикористовуйте формат: '35 EUR продукти' або просто надішліть фото чека.",
    }
}
